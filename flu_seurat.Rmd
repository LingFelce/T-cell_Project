...
# add to metadata
flu@meta.data$"timepoint" <- as.factor(flu_filtered_samples$timepoint)
```
...
```{r harmony_umap, fig.height=5, fig.width=18}
flu <- flu %>%
...
```{r, fig.height=46, fig.width=30}
VlnPlot(object = flu, features = as.vector(tgenes$V1),ncol=6, group.by = "timepoint")
```
