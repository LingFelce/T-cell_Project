...
VlnPlot(object = tcell2, features =c("SMC5", "DUSP1", "TNFSF8", "CD200", "FAT1", "S100A4", "GBP1", "LTB"))
```

```{r, fig.height=18, fig.width=22}
# overlay gene expression onto UMAPs
FeaturePlot(object = tcell2, features = c("IL2","CCL20","ZFP36","PRF1","GPR183","DUSP1","SMC5","JAK1","TNFSF14","TNF","CORO1A","S100A4","LTB","GBP1","CD8A","CD8B","CD4", "FOXP3", "CD69","HLA-A","HLA-B","HLA-C"), cols = c("grey", "blue"), reduction = "umap")
```
...
FeaturePlot(object = tcell2, features = c("CCR7", "CXCR3", "CXCR4"), cols = c("grey", "blue"), ncol = 3, reduction = "umap")
```

### Cytokine receptors and other markers
```{r, fig.height=14, fig.width=16}
FeaturePlot(object = tcell2, 
            features = c("CD4", "CD8A", "CD8B", "PTPRC", "IFNGR2", "FAS", "CD69","CD27",  "CD28", "PDCD1", "POU2AF1", "IL7R", "SELL"), 
...
FeaturePlot(object = tcell2, 
            features = c("CCL5", "CCL20", "IL2", "IL16", "IL21", "TNF", "LTA", "IFNG", "FASLG", "TNFSF10", "OAS1", "MX1"), 
            cols = c("grey", "blue"), reduction = "umap", ncol= 3)
```
...
FeaturePlot(object = tcell2, 
            features = c("PTPRC", "CCR7", "SELL", "CD28", "IL7R"), 
            cols = c("grey", "blue"), reduction = "umap", ncol= 3)
```
### T follicular helper
```{r, fig.height=4, fig.width=14}
FeaturePlot(object = tcell2, 
            features = c("IL21", "POU2AF1", "PDCD1"), 
            cols = c("grey", "blue"), reduction = "umap", ncol= 3)
```
