...
```{r top 2 genes, fig.height=12, fig.width=16}
...
### Treg
```{r, fig.height=4, fig.width=16}
FeaturePlot(object = tcell2, features = c("IL10", "IL35", "TGFB1", "LGALS1"), cols = c("grey", "blue"), ncol = 3, reduction = "umap")
```
### Memory
```{r, fig.height=12, fig.width=16}
FeaturePlot(object = tcell2, features = c("PTPRC", "CCR7", "SELL", "TCF7", "STAT5", "CD44", "IL7R", "S100A4","CD154", "CD38", "CD137"), cols = c("grey", "blue"), ncol = 3, reduction = "umap")
```
