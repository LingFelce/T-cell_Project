...
### Cytokine receptors and other CD markers
```{r, fig.height=8, fig.width=14}
FeaturePlot(object = tcell2, 
            features = c("CD4", "CD8A", "CD8B", "IFNGR2", "FAS", "CD69", "CD28"), 
...
FeaturePlot(object = tcell2, 
            features = c("CCL20", "IL2", "IL16", "TNF", "LTA", "IFNG", "FASLG", "TNFSF10"), 
...
FeaturePlot(object = tcell2, 
            features = c("GZMA", "GZMB", "GZMH", "GZMK", "GZMM", "PRF1"), 
            cols = c("grey", "blue"), reduction = "umap", ncol= 3)
```
