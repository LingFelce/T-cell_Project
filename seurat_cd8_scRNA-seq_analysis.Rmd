...
FeaturePlot(object = cd8, features = c("ITGA4", "ITGAL", "ITGB2", "CCL4", "CCL5", "CXCR3", "CXCR4"), cols = c("grey", "blue"), reduction = "umap")
```
...
FeaturePlot(object = acute, features = c("ITGA4", "ITGAL", "ITGB2", "CCL4", "CCL5", "CXCR3", "CXCR4"), cols = c("grey", "blue"), reduction = "umap")
```
...
FeaturePlot(object = conv, features = c("ITGA4", "ITGAL", "ITGB2", "CCL4", "CCL5", "CXCR3", "CXCR4"), cols = c("grey", "blue"), reduction = "umap")
```
