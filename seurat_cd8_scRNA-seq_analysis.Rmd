...
```
## ORF3a-28 High v ORF3a-28 Low Functional Avidity
...
o1 <- ggplot(orf3a_cl@meta.data, aes(x=hclust, y=Features.Memory1, colour=hclust)) +
  geom_boxplot(width=0.5, outlier.shape=NA ) + geom_jitter(width=0.25) +
  labs(title="Memory score",x="Functional Avidity", y = "Memory score") + theme_light()+
  theme(plot.title = element_text(size=20))

o2 <- ggplot(orf3a_cl@meta.data, aes(x=hclust, y=Features.Activation1, colour=hclust)) +
  geom_boxplot(width=0.5, outlier.shape=NA ) + geom_jitter(width=0.25) +
  labs(title="Activation score",x="Functional Avidity", y = "Activation score") + theme_light()+
  theme(plot.title = element_text(size=20))

o3 <- ggplot(orf3a_cl@meta.data, aes(x=hclust, y=Features.Cytotoxicity1, colour=hclust)) +
  geom_boxplot(width=0.5, outlier.shape=NA ) + geom_jitter(width=0.25) +
  labs(title="Cytotoxicity score",x="Functional Avidity", y = "Cytotoxicity score") + theme_light()+
  theme(plot.title = element_text(size=20))

o4 <- ggplot(orf3a_cl@meta.data, aes(x=hclust, y=Features.Cytokines1, colour=hclust)) +
  geom_boxplot(width=0.5, outlier.shape=NA ) + geom_jitter(width=0.25) +
  labs(title="Cytokines score",x="Functional Avidity", y = "Cytokines score") + theme_light()+
  theme(plot.title = element_text(size=20))

o5 <- ggplot(orf3a_cl@meta.data, aes(x=hclust, y=Features.Integrins1, colour=hclust)) +
  geom_boxplot(width=0.5, outlier.shape=NA ) + geom_jitter(width=0.25) +
  labs(title="Integrins score",x="Functional Avidity", y = "Integrins score") + theme_light()+
  theme(plot.title = element_text(size=20))

o6 <- ggplot(orf3a_cl@meta.data, aes(x=hclust, y=Features.Exhaustion1, colour=hclust)) +
  geom_boxplot(width=0.5, outlier.shape=NA ) + geom_jitter(width=0.25) +
  labs(title="Exhaustion score",x="Functional Avidity", y = "Exhaustion score") + theme_light()+
  theme(plot.title = element_text(size=20))

o7 <- ggplot(orf3a_cl@meta.data, aes(x=hclust, y=Features.NK1, colour=hclust)) +
  geom_boxplot(width=0.5, outlier.shape=NA ) + geom_jitter(width=0.25) +
  labs(title="NK cell genes score",x="Functional Avidity", y = "NK cell genes score") + 
  theme_light() +
  theme(plot.title = element_text(size=20))
...
```{r, fig.height=10, fig.width=20}
grid.arrange(o1, o2, o3, o4, o5, o6, o7, nrow=2)
```
## Stats
```{r}
# independent 2-group Mann-Whitney U Test (non-parametric)
# where y is numeric and A is A binary factor
wilcox.test(cd8$Features.Memory1~cd8$epitope)
wilcox.test(cd8$Features.Activation1~cd8$epitope)
wilcox.test(cd8$Features.Cytotoxicity1~cd8$epitope)
wilcox.test(cd8$Features.Cytokines1~cd8$epitope)
wilcox.test(cd8$Features.Integrins1~cd8$epitope)
wilcox.test(cd8$Features.Exhaustion1~cd8$epitope)
wilcox.test(cd8$Features.NK1~cd8$epitope)

wilcox.test(np16_cl$Features.Memory1~np16_cl$hclust)
wilcox.test(np16_cl$Features.Activation1~np16_cl$hclust)
wilcox.test(np16_cl$Features.Cytotoxicity1~np16_cl$hclust)
wilcox.test(np16_cl$Features.Cytokines1~np16_cl$hclust)
wilcox.test(np16_cl$Features.Integrins1~np16_cl$hclust)
wilcox.test(np16_cl$Features.Exhaustion1~np16_cl$hclust)
wilcox.test(np16_cl$Features.NK1~np16_cl$hclust)

wilcox.test(orf3a_cl$Features.Memory1~orf3a_cl$hclust)
wilcox.test(orf3a_cl$Features.Activation1~orf3a_cl$hclust)
wilcox.test(orf3a_cl$Features.Cytotoxicity1~orf3a_cl$hclust)
wilcox.test(orf3a_cl$Features.Cytokines1~orf3a_cl$hclust)
wilcox.test(orf3a_cl$Features.Integrins1~orf3a_cl$hclust)
wilcox.test(orf3a_cl$Features.Exhaustion1~orf3a_cl$hclust)
wilcox.test(orf3a_cl$Features.NK1~orf3a_cl$hclust)
