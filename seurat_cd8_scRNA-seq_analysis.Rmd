...
cd8 <- subset(x = cd8, subset = nFeature_RNA > 200 & nFeature_RNA < 6000 & percent.mito >  -Inf & percent.mito < 0.05 )
```
...
VlnPlot(object = cd8, features =c("CD69", "CCR7", "PRF1", "CCL3", "MCM5", "TUBB"), ncol=4)
```
