...
cd8 <- AddMetaData(object = cd8, metadata = clusters$cluster, col.name = "hclust")
...
np16_cl <- subset(cd8, idents=c("NP16 A", "NP16 B", "NP16 C", "NP16 D", "NP16 E", "NP16 F", "NP16 G", "NP16 H"))
...
orf3a_cl <- subset(cd8, idents=c("ORF3a-28 A", "ORF3a-28 B", "ORF3a-28 C", "ORF3a-28 D", "ORF3a-28 E", "ORF3a-28 F", "ORF3a-28 G", "ORF3a-28 H"))
