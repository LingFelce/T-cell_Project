...
VlnPlot(object = cd8, features=c("PTPRC", "CCR7", "SELL", "TCF7", "IL7R", "S100A4", 
                                  ...
                                  "MKI67","TUBA1B","PDCD1", "HAVCR2", "TIGIT", "CTLA4"),
...
# 
# Idents(np16) <- "CDR3_group"
# np16_2 <- subset(np16, subset = CDR3_group !="NP16_NA")
# 
# 
...
# 
# Idents(orf3a) <- "CDR3_group"
# orf3a_2 <- subset(orf3a, subset = CDR3_group !="ORF3a-28_NA")
# 
