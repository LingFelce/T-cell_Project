...
# Chemokine/cytokine expression on UMAPs
...
FeaturePlot(object = cd8, features = c("CCL4", "CCL5", "CXCR3", "CXCR4"), cols = c("grey", "blue"), reduction = "umap")
```
...
FeaturePlot(object = acute, features = c("CCL4", "CCL5", "CXCR3", "CXCR4"), cols = c("grey", "blue"), reduction = "umap")
```
...
FeaturePlot(object = conv, features = c("CCL4", "CCL5", "CXCR3", "CXCR4"), cols = c("grey", "blue"), reduction = "umap")
```
