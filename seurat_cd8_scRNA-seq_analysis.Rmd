...
```{r top 2 genes, fig.height=10, fig.width=8}
# Top 2 genes from each cluster
VlnPlot(object = cd8, features =c("CD69", "CCR7", "PRF1", "CCL3", "MCM5", "TUBB"), ncol=2)
```
...
clin.type <- rep(c("mild", "severe","severe","severe","severe","severe","mild", "severe","severe"), 
                 times = c("133", "94", "15", "74", "95", "66", "75", "46", "95"))
