...
VlnPlot(object = cd8, features = c("CXCR3", "CXCR4", "CCR4", "CCR5", "CCR6", "CXCR6",
...
cell_groups$epitope <- ifelse(grepl("NP16|B7", cell_groups$cell_name), "NP16",
                              ifelse(grepl("ORF", cell_groups$cell_name), "ORF3a-28",""))
...
```{r}
DimPlot(cd8, reduction = "umap", group.by = "CDR3_group")
```
...
DimPlot(np16_2, reduction = "umap", group.by = "CDR3_group")
