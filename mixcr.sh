...
cd /t1-data/user/lfelce/MiXCR/CD8_ORF_input/ #input directory
DIR=/t1-data/user/lfelce/MiXCR/CD8_ORF_output/ # output directory
...
#$ -q batchq
module add mixcr
cd /t1-data/user/lfelce/MiXCR/CD8_ORF_input/
...
cd /t1-data/user/lfelce/MiXCR/CD8_ORF_output/script/
