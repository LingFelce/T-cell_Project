...
```
#### Subset known demultiplex cells
```{r}
...
# Select top PCs for clustering
t2.known <- FindNeighbors(t2.known, reduction = "pca", dims = 1:25, verbose=FALSE)
t2.known <- FindClusters(t2.known, resolution = 0.5, verbose = FALSE)
t2.known <- RunUMAP(t2.known, dims = 1:25, verbose=FALSE)
t2.known <- RunTSNE(t2.known, reduction = "pca", dims = 1:25, verbose=FALSE)
