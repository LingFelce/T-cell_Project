...
# combine clones and single cell info
np16 <- rbind(np16_sc, np16_clones)

orf3a <- rbind(orf3a_sc, orf3a_clones)
...
# for saving later
cells <- rbind(cells, correct_labels)
...
```{r}
write.csv(cells, "/t1-data/user/lfelce/TCR_analysis/diversity/cd8_np16_orf3a_sc_clones_dendrograms.csv")
```
