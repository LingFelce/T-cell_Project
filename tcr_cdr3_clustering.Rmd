...
legend("topright", legend = levels(patient), fill = cols_5, cex=2)
...
correct_labels$patient <- ifelse(grepl("1105", correct_labels$correct_labels), "1105",
                          ifelse(grepl("1134",correct_labels$correct_labels), "1134",
...
legend("topright", legend = levels(patient), fill = cols_4, cex=2)
...
correct_labels <- cl$labels[cl$order]
correct_labels <- as.data.frame(correct_labels)
correct_labels$epitope <- ifelse(grepl("NP16|B7_SPR", correct_labels$correct_labels), "NP16",
                          ifelse(grepl("ORF3a",correct_labels$correct_labels), "ORF3a-28",""))
labels(dend) <- correct_labels$epitope  
