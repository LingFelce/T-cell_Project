...
d <- stringdistmatrix(np16$CDR3_beta, np16$CDR3_beta)
...
dend %>% 
    ...
    plot(main = "CD8+ NP16 CDR3 beta clustering")
legend("topright", legend = levels(patient), fill = cols_5)
...
```{r}
# generate distance matrix
d <- stringdistmatrix(orf3a$CDR3_beta, orf3a$CDR3_beta)
...
dend %>% 
    ...
    plot(main = "CD8+ ORF3a-28 CDR3 beta clustering")
legend("topright", legend = levels(patient), fill = cols_4)
