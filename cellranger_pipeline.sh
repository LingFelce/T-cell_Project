...
# cellranger count for just gene expression
#!/bin/bash
#$ -wd /well/jknight/users/jln789/10x_Dong050121/fastq_Dong050121/outs/fastq_path/
#$ -q short.qc

cd /well/jknight/users/jln789/10x_Dong050121/fastq_Dong050121/outs/fastq_path/

module load CellRanger/5.0.0

cellranger count --id=count_T1_Dong050121 \
