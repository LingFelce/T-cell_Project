# some functions modified from Adam's original version - see MLLT1 or Felce Project repositories for original file
...
filter_genes <- function(result, name){
  ...
  test <-tibble::rownames_to_column(test, "Gene")
  res <- na.omit(test)
