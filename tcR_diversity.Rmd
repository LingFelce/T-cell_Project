...
Each repertoire is single patient, remove non-expanded TCR clones
...
# combine frequency with other info
combined <- merge(trb, table, by.x="CDR3_beta", by.y="Var1", all.x=TRUE)

# remove rows where TCR frequency is 1
combined2 <- combined[!(combined$Freq==1),]
...
combined3$tcr <- ifelse(grepl("TRBV28_TRBJ1-1|TRBV27_TRBJ2-4|TRBV2_TRBJ2-2|TRBV13_TRBJ1-2|
TRBV5-1_TRBJ2-5|TRBV4-1_TRBJ2-3|TRBV6-6_TRBJ2-7",combined3$beta), "shared", "convalescent only")
