...
# combined3 <- rbind(np16, orf3a)
# 
# combined3$tcr <- ifelse(grepl("TRBV5-1_TRBJ2-1|TRBV28_TRBJ1-1|TRBV27_TRBJ2-4|TRBV2_TRBJ2-2|TRBV13_TRBJ1-2|TRBV4-2_TRBJ2-1|TRBV4-1_TRBJ2-3|TRBV5-1_TRBJ2-7|TRBV6-6_TRBJ2-7|TRBV5-1_TRBJ2-5",combined3$beta), "shared", ifelse(grepl("TRBV29-1_TRBJ2-1|TRBV9_TRBJ2-3|TRBV7-9_TRBJ1-6|TRBV7-1, TRBV28_TRBJ2-7", combined3$beta), "acute only", ifelse(!grepl("TRBV5-1_TRBJ2-1|TRBV28_TRBJ1-1|TRBV27_TRBJ2-4|TRBV2_TRBJ2-2|TRBV13_TRBJ1-2|TRBV4-2_TRBJ2-1|TRBV4-1_TRBJ2-3|TRBV5-1_TRBJ2-7|TRBV6-6_TRBJ2-7|TRBV5-1_TRBJ2-5|TRBV29-1_TRBJ2-1|TRBV9_TRBJ2-3|TRBV7-9_TRBJ1-6|TRBV7-1, TRBV28_TRBJ2-7", combined3$beta), "convalescent only", "")))
# 
# np16_2 <- combined3[!grepl("ORF3a-28", combined3$epitope),]
...
#   labs(title="Diversity of CD8+ NP16 & ORF3a-28 CDR3 beta",x="Patient", y = "Shannon diversity index")
# 
# p2 <- ggplot(combined3, aes(x=patient, y=diversity, colour=tcr)) +
#   geom_jitter(width=0.25) +
#   labs(title="Diversity of CD8+ NP16 & ORF3a-28 CDR3 beta",x="Patient", y = "Shannon diversity index")
# 
# 
# p3 <- ggplot(combined3, aes(x=epitope, y=diversity, colour=epitope)) +
#   geom_boxplot(width=0.5)+ geom_jitter(width=0.25) +
#   labs(title="Diversity of CD8+ NP16 & ORF3a-28 CDR3 beta",x="Epitope", y = "Shannon diversity index")
# 
# p4 <- ggplot(combined3, aes(x=epitope, y=diversity, colour=tcr)) + 
#   geom_jitter(width=0.25) +
#   labs(title="Diversity of CD8+ NP16 & ORF3a-28 CDR3 beta",x="Epitope", y = "Shannon diversity index")
# 
# 
# p5 <- ggplot(np16_2, aes(x=severity, y=diversity, colour=severity)) +
#   geom_boxplot(width=0.5)+ geom_jitter(width=0.25) +
#   labs(title="Diversity of CD8+ NP16 CDR3 beta",x="Severity", y = "Shannon diversity index")
# 
# p6 <- ggplot(np16_2, aes(x=severity, y=diversity, colour=tcr)) +
#   geom_jitter(width=0.25) +
#   labs(title="Diversity of CD8+ NP16 CDR3 beta",x="Severity", y = "Shannon diversity index")
# 
# 
# p7 <- ggplot(combined3, aes(x=timepoint, y=diversity, colour=timepoint)) +
#   geom_boxplot(width=0.5)+ geom_jitter(width=0.25) +
#   labs(title="Diversity of CD8+ NP16 & ORF3a-28 CDR3 beta",x="Timepoint", y = "Shannon diversity index")
# 
# p8 <- ggplot(combined3, aes(x=timepoint, y=diversity, colour=tcr)) +
#   geom_jitter(width=0.25) +
#   labs(title="Diversity of CD8+ NP16 & ORF3a-28 CDR3 beta",x="Timepoint", y = "Shannon diversity index")
```
...
# grid.arrange(p3, p4, p7, p8, p5, p6, nrow=3)
```
...
# t.test(combined3$diversity~combined3$epitope)
# 
# t.test(combined3$diversity~combined3$timepoint)
# 
# t.test(np16$diversity~np16$severity)
# 
...
# NP16 and ORF3a-28 single beta cell using Isar's diversity code - REPEAT
Each repertoire is single patient, keep all clones (even non-expanded)
...
combined2$patient <- ifelse(grepl("005", combined2$cell_name), "005",
                          ...
                          ifelse(grepl("1201", combined2$cell_name), "1201",
                          ifelse(grepl("1105", combined2$cell_name), "1105",
                          ifelse(grepl("1134-TP-2",combined2$cell_name), "1134",
                          ifelse(grepl("1525-TP-1", combined2$cell_name), "1525-TP-1",
                          ifelse(grepl("1525-TP-2", combined2$cell_name), "1525-TP-2",
                                 "")))))))))
combined2$severity <- ifelse(grepl("005", combined2$cell_name), "mild",
                          ...
                          ifelse(grepl("1201", combined2$cell_name), "mild",
                          ifelse(grepl("1105", combined2$cell_name), "severe",
                          ifelse(grepl("1134",combined2$cell_name), "severe",
                          ifelse(grepl("1525-TP-1", combined2$cell_name), "severe",
                          ifelse(grepl("1525-TP-2", combined2$cell_name), "severe",
                                 "")))))))))
combined2$timepoint <- ifelse(grepl("TP-1", combined2$patient), "acute",
                   ifelse(grepl("005|TP-2|1134|1153|1201|1105", combined2$cell_name), "convalescent", ""))

combined2$epitope <- ifelse(grepl("NP16|B7_SPR", combined2$cell_name), "NP16",
                 ifelse(grepl("ORF3a-28", combined2$cell_name), "ORF3a-28", ""))

# subset data by patient
p005 <- combined2[(combined2$patient=="005"),]
p1131TP1 <- combined2[(combined2$patient=="1131-TP-1"),]
p1131TP2 <- combined2[(combined2$patient=="1131-TP-2"),]
p1153 <- combined2[(combined2$patient=="1153"),]
p1201 <- combined2[(combined2$patient=="1201"),]
p1105 <- combined2[(combined2$patient=="1105"),]
p1134 <- combined2[(combined2$patient=="1134"),]
p1525TP1 <- combined2[(combined2$patient=="1525-TP-1"),]
p1525TP2 <- combined2[(combined2$patient=="1525-TP-2"),]

# tabulate frequencies and distribution by CDR3 sequence v cell name
table_005 <- as.data.frame.matrix(table(p005$CDR3_beta, p005$cell_name))
table_1131TP1 <- as.data.frame.matrix((table(p1131TP1$CDR3_beta, p1131TP1$cell_name)))
table_1131TP2 <- as.data.frame.matrix((table(p1131TP2$CDR3_beta, p1131TP2$cell_name)))
table_1153 <- as.data.frame.matrix((table(p1153$CDR3_beta, p1153$cell_name)))
table_1201 <- as.data.frame.matrix((table(p1201$CDR3_beta, p1201$cell_name)))
table_1105 <- as.data.frame.matrix((table(p1105$CDR3_beta, p1105$cell_name)))
table_1134 <- as.data.frame.matrix((table(p1134$CDR3_beta, p1134$cell_name)))
table_1525TP1 <- as.data.frame.matrix((table(p1525TP1$CDR3_beta, p1525TP1$cell_name)))
table_1525TP2 <- as.data.frame.matrix((table(p1525TP2$CDR3_beta, p1525TP2$cell_name)))

# diversity index calculation
div_005 <- as.data.frame(diversity_function(table_005, "shannon"))
div_1131TP1 <- as.data.frame(diversity_function(table_1131TP1, "shannon"))
div_1131TP2 <- as.data.frame(diversity_function(table_1131TP2, "shannon"))
div_1153 <- as.data.frame(diversity_function(table_1153, "shannon"))
div_1201 <- as.data.frame(diversity_function(table_1201, "shannon"))
div_1105 <- as.data.frame(diversity_function(table_1105, "shannon"))
div_1134 <- as.data.frame(diversity_function(table_1134, "shannon"))
div_1525TP1 <- as.data.frame(diversity_function(table_1525TP1, "shannon"))
div_1525TP2 <- as.data.frame(diversity_function(table_1525TP2, "shannon"))

# add back to subsetted data
div_005 <- tibble::rownames_to_column(div_005, "CDR3_beta")
colnames(div_005) <- c("CDR3_beta", "diversity")

div_1131TP1 <- tibble::rownames_to_column(div_1131TP1, "CDR3_beta")
colnames(div_1131TP1) <- c("CDR3_beta", "diversity")

div_1131TP2 <- tibble::rownames_to_column(div_1131TP2, "CDR3_beta")
colnames(div_1131TP2) <- c("CDR3_beta", "diversity")

div_1153 <- tibble::rownames_to_column(div_1153, "CDR3_beta")
colnames(div_1153) <- c("CDR3_beta", "diversity")

div_1201 <- tibble::rownames_to_column(div_1201, "CDR3_beta")
colnames(div_1201) <- c("CDR3_beta", "diversity")

div_1105 <- tibble::rownames_to_column(div_1105, "CDR3_beta")
colnames(div_1105) <- c("CDR3_beta", "diversity")

div_1134<- tibble::rownames_to_column(div_1134, "CDR3_beta")
colnames(div_1134) <- c("CDR3_beta", "diversity")

div_1525TP1 <- tibble::rownames_to_column(div_1525TP1, "CDR3_beta")
colnames(div_1525TP1) <- c("CDR3_beta", "diversity")

div_1525TP2 <- tibble::rownames_to_column(div_1525TP2, "CDR3_beta")
colnames(div_1525TP2) <- c("CDR3_beta", "diversity")

p005 <- merge(p005, div_005, by="CDR3_beta", all.x=TRUE)
p005 <- p005[!duplicated(p005$CDR3_beta),]

p1131TP1 <- merge(p1131TP1, div_1131TP1, by="CDR3_beta", all.x=TRUE)
p1131TP1 <- p1131TP1[!duplicated(p1131TP1$CDR3_beta),]

p1131TP2 <- merge(p1131TP2, div_1131TP2, by="CDR3_beta", all.x=TRUE)
p1131TP2 <- p1131TP2[!duplicated(p1131TP2$CDR3_beta),]

p1153 <- merge(p1153, div_1153, by="CDR3_beta", all.x=TRUE)
p1153 <- p1153[!duplicated(p1153$CDR3_beta),]

p1201 <- merge(p1201, div_1201, by="CDR3_beta", all.x=TRUE)
p1201 <- p1201[!duplicated(p1201$CDR3_beta),]

p1105 <- merge(p1105, div_1105, by="CDR3_beta", all.x=TRUE)
p1105 <- p1105[!duplicated(p1105$CDR3_beta),]

p1134 <- merge(p1134, div_1134, by="CDR3_beta", all.x=TRUE)
p1134 <- p1134[!duplicated(p1134$CDR3_beta),]

p1525TP1 <- merge(p1525TP1, div_1525TP1, by="CDR3_beta", all.x=TRUE)
p1525TP1 <- p1525TP1[!duplicated(p1525TP1$CDR3_beta),]

p1525TP2 <- merge(p1525TP2, div_1525TP2, by="CDR3_beta", all.x=TRUE)
p1525TP2 <- p1525TP2[!duplicated(p1525TP2$CDR3_beta),]


# combine for plotting
combined3 <- rbind(p005, p1131TP1, p1131TP2, p1153, p1201, p1105, p1134, p1525TP1, p1525TP2)
...
p3 <- ggplot(combined3, aes(x=epitope, y=diversity)) +
  geom_boxplot(width=0.5)+ geom_jitter(width=0.25, aes(colour=tcr)) +
  labs(title="Diversity of CD8+ NP16 & ORF3a-28 CDR3 beta",x="Epitope", y = "Shannon diversity index") + theme_light()


p4 <- ggplot(np16_2, aes(x=severity, y=diversity)) +
  geom_boxplot(width=0.5)+ geom_jitter(width=0.25, aes(colour=tcr)) +
  labs(title="Diversity of CD8+ NP16 CDR3 beta",x="Severity", y = "Shannon diversity index") + theme_light()


p5 <- ggplot(combined3, aes(x=timepoint, y=diversity)) +
  geom_boxplot(width=0.5)+ geom_jitter(width=0.25, aes(colour=epitope)) +
  labs(title="Diversity of CD8+ NP16 & ORF3a-28 CDR3 beta",x="Timepoint", y = "Shannon diversity index") + theme_light()
...
t.test(np16_2$diversity~np16_2$severity)
